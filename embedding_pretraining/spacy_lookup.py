...
def spacy_lookup(dataset, notes_filename):

    tokens_filename = get_dataset_filename(dataset, ALL_FILENAME, TOKEN_COUNT_POSTFIX, JSON_FILE_EXTENSION)
    tokens = load_json(tokens_filename)
